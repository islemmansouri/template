            ...
            <div className="row justify-content-between">
              ...
              <div className="col-lg-6">
                <div className="nav nav-tabs food_menu_nav" id="myTab" role="tablist">
                  <a className="active"  id="Breakfast-tab" data-toggle="tab" href="#Breakfast" role="tab" aria-controls="Breakfast" aria-selected="true">Classics<img src="img/icon/play.svg" alt="play" /></a>
                </div>
              </div>
              <div className="col-lg-12">
