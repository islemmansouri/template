          ...
          return (
            ...
            <div className="login-signup l-attop" id="login">
              ...
              <div className="login-signup-content">
                ...
                <input type="text" name="username" defaultValue className="field-input" />
                <div className="input-name input-margin">
                  <h2>Password</h2>
                </div>
                <input type="text" name="password" defaultValue className="field-input" />
            ...
            <div className="login-signup s-atbottom" id="signup">
              ...
              <div className="input-name">
                ...
                <input type="text" name="fullname" defaultValue className="field-input" />
                ...
                <input type="text" name="email" defaultValue className="field-input" />
                <div className="input-name input-margin">
                  <h2>Password</h2>
                </div>
                <input type="text" name="password" defaultValue className="field-input" />
