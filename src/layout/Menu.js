            ...
            <div className="row justify-content-between">
              ...
              <div className="col-lg-6">
                <div className="nav nav-tabs food_menu_nav" id="myTab" role="tablist">
                  <a className="active"  id="Breakfast-tab" data-toggle="tab" href="#Breakfast" role="tab" aria-controls="Breakfast" aria-selected="true">Breakfast <img src="img/icon/play.svg" alt="play" /></a>
                  <a id="Lunch-tab" data-toggle="tab" href="#Lunch" role="tab" aria-controls="Lunch" aria-selected="false">Lunch <img src="img/icon/play.svg" alt="play" /></a>
